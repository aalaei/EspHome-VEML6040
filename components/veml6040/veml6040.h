...
namespace esphome
{
  namespace veml6040
  {
    ...
    public:
      ...
      void set_color_red_sensor(sensor::Sensor *color_red_sensor)
      {
        color_red_sensor_ = color_red_sensor;
      }
      void set_color_green_sensor(sensor::Sensor *color_green_sensor)
      {
        color_green_sensor_ = color_green_sensor;
      }
      void set_color_blue_sensor(sensor::Sensor *color_blue_sensor)
      {
        color_blue_sensor_ = color_blue_sensor;
      }
      void set_color_white_sensor(sensor::Sensor *color_white_sensor)
      {
        color_white_sensor_ = color_white_sensor;
      }
    ...
    protected:
      ...
      sensor::Sensor *color_red_sensor_{nullptr};
      sensor::Sensor *color_green_sensor_{nullptr};
      sensor::Sensor *color_blue_sensor_{nullptr};
      sensor::Sensor *color_white_sensor_{nullptr};
