...
namespace esphome
{
    namespace veml6040
    {
        ...
        void VEML6040Component::update()
        {
            ...
            float total= raw_r+raw_g+raw_b;
            if (this->color_red_sensor_ != nullptr)
                this->color_red_sensor_->publish_state(raw_r/total);
            if (this->color_green_sensor_ != nullptr)
                this->color_green_sensor_->publish_state(raw_g/total);
            if (this->color_blue_sensor_ != nullptr)
                this->color_blue_sensor_->publish_state(raw_b/total);
            if (this->color_white_sensor_ != nullptr)
                this->color_white_sensor_->publish_state(log(raw_w)/log(65534));
